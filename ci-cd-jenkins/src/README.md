...
```export PYTHONPATH="/Users/gursimran2407/Desktop/author-repo/Complete-MLOps-BootCamp/Packaging-ML-Model/packaging-ml-model:$PYTHONPATH"
```
...
```
pip install git+https://github.com/gursimran2407/prediction_model.git
```
