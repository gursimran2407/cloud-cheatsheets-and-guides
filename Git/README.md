...
git config --global user.name "gursimran2407"
git config --global user.email "support@gursimran2407.in"
...
git clone https://github.com/gursimran2407/git4mlops.git my-folder
cd my-folder
git branch --all
